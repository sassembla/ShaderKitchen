...
public class ClassIdCollector {
	public static readonly Dictionary<int, string> classIdNamePair = new Dictionary<int, string>() {
		{1, "GameObject"},
		{2, "Component"},
		{3, "LevelGameManager"},
		{4, "Transform"},
	...
	public static string NameFromClassId (int classId) {
		if (classIdNamePair.ContainsKey(classId)) return classIdNamePair[classId];
