##Outline2
Cameraのデプスバッファからアウトラインを作ります

中身はUnityTutorialのEdgeDetectそのままです
[参考　Nao_uの日記](http://game.g.hatena.ne.jp/Nao_u/00130407)<br>
[参考　安井のブログ](http://yasuiyasuo.blogspot.jp/2013/03/unityshader.html)<br>

Shader Replacement　のUnityチュートリアルからEdgeDetectNormalのシーンを使います<br>
※ImageEffect使うのでProが必要になります<br>
（線がガタガタになるのを滑らかにするにはもう一回ポストエフェクトしないとだめ？）

EdgeDetectCamera.cs<br>
```
using UnityEngine;
...
public class EdgeDetectCamera:ImageEffectBase
{
	void Start ()
	{
