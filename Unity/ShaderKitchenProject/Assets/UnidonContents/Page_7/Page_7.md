##HalfLambert+RmLight
StandardShaderのライティングに、シンプルなHalfLambert+RimLightでどこまで似せられるか簡単に実験してみました<br>

計算としては適当です。　それっぽい色味になるようにあれこれ調整しているので、物理的には全く正しくありません　:P<br>

いままでのHalfLambert　Shaderに、PhongのハイライトとRimライトの照り返しを合体させたものです<br>
Phongのハイライトは白になってしまっていたので、強さの調整ができるようにしてあります<br>
